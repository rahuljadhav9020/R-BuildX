...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    try {
        ...
        $stmt = $pdo->prepare("INSERT INTO vehicle_orders 
                              ...
                              VALUES ('Dumper', :name, :email, :mobile, :location, :purpose, :rate, :other)");
...
<body style="background-image: url(dumper.png); background-position:center; background-size:cover">
    ...
    $(document).ready(function() {
        ...
        // Update rate when location or material type changes
        $('#location, #mtrl').change(updateRate);
    });
    </script>
</body>
